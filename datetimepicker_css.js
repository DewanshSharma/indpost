var c=0;//Javasript name: My Date Time Picker
...
{document.getElementById('dtAnchor').innerHTML="Please be available at selected date and time".fontcolor("green");if(c>=1)
		document.getElementById("submit").disabled = false;c=c+1;
...
function Validation(){
	var x=document.the_form.pacwt.value;
	var y=/^[0-9]+$/;
	if(x.match(y)){
	document.getElementById('pacwtAnchor').innerHTML="";
if(c>=1)
	...
	document.getElementById('pacwtAnchor').innerHTML="Invalid Package Size".fontcolor("red");
